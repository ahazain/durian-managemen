...
import { Calendar, CheckCircle, Clock, Citrus as Fruit } from 'lucide-react';
...
export const EmployeeDashboard: React.FC = () => {
  ...
  const nextSchedule = {
    ...
    date: format(new Date(today.getTime() + 24 * 60 * 60 * 1000), 'MMMM d, yyyy'),
    startTime: '07:00 AM',
    endTime: '11:00 AM',
  };
      ...
      <Card className="mb-6">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-gray-600">
              {format(today, 'MMMM d, yyyy')} | Current time: {format(today, 'h:mm a')}
            </p>
          </div>
          <Button
            variant={hasCheckedInToday ? 'success' : 'primary'}
            icon={hasCheckedInToday ? <CheckCircle size={18} /> : <Clock size={18} />}
            disabled={hasCheckedInToday}
          >
            {hasCheckedInToday ? 'Checked In' : 'Check In Now'}
          </Button>
        </div>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
        ...
        <Card className="col-span-2">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="text-lg font-medium text-gray-800">Next Schedule</h3>
              <div className="mt-2">
                <h4 className="font-semibold text-durian-800">{nextSchedule.title}</h4>
                <p className="text-gray-600 text-sm">{nextSchedule.date}</p>
                <p className="text-gray-600 text-sm">{nextSchedule.startTime} - {nextSchedule.endTime}</p>
              </div>
              <div className="mt-3">
                <Button
                  variant="outline"
        ...
        {/* Monthly Attendance */}
        <Card>
          <h3 className="text-lg font-medium text-gray-800 mb-3">Monthly Attendance</h3>
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm text-gray-600">Present</span>
              <span className="font-semibold text-green-600">{attendanceStats.present} days</span>
            </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-red-600">{attendanceStats.absent} days</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div 
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="font-semibold text-yellow-600">{attendanceStats.late} days</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-2.5">
              <div 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-gray-600 mt-1">Mark attendance & view history</p>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-gray-600 mt-1">View upcoming schedules</p>
            </div>
          </div>
          ...
          >
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-xs text-gray-600 mt-1">Predict durian quality</p>
            </div>
          </div>
        </div>
      </Card>
